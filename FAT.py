...
if __name__ == '__main__':
    ...
    cap1,cap2,cap3,pipeline=initialize_cams()
    cams=(cap1,cap2,cap3,pipeline)
    tag_pos=find_position_of_tag(cams,2)
    # pickup camera
    ...
    code = arm.set_position_aa([place[0]-4]+[place[1]]+[place[2]-114]+place[3:], speed=50,mvacc=100, wait=True)

    code,place=arm.get_position_aa(is_radian=False)

    code = arm.set_position_aa([place[0]]+[place[1]+12]+[place[2]]+place[3:], speed=50,mvacc=100, wait=True)

    code = arm.set_position_aa([place[0]]+[place[1]+15]+[place[2]]+place[3:], speed=30,mvacc=100, wait=False)
